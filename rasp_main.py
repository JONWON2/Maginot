...
class Tread1(threading.Thread):
    ...
    def run(self) -> None:
        ...
        sender = imagezmq.ImageSender(connect_to='tcp://116.121.38.22:12223')
...
class Tread2(threading.Thread):
    ...
    def run(self)-> None:
        ...
        # 접속할 서버 주소 지금은 로컬
        # host = '192.168.0.199' # 507
        host = '192.168.0.199' # 510
        # host = '192.168.0.199' # 511
        # host = '192.168.0.13'  # myhome
